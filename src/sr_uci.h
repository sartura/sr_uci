...
typedef int (*sr_callback)(sr_ctx_t *, sr_change_oper_t, sr_val_t *, sr_val_t *,
                           char *, char *);
typedef int (*uci_callback)(sr_ctx_t *, char *, char *, sr_edit_flag_t, void *);
/* additinonal check */
typedef bool (*check_callback)(sr_ctx_t *, char *, char *, sr_edit_flag_t,
                               void *);
...
int sr_section_cb(sr_ctx_t *, sr_change_oper_t, sr_val_t *, sr_val_t *, char *,
                  char *);
/* sysrepo callback for leaf's */
int sr_option_cb(sr_ctx_t *, sr_change_oper_t, sr_val_t *, sr_val_t *, char *,
                 char *);
/* sysrepo callback for boolean values */
int sr_boolean_cb(sr_ctx_t *, sr_change_oper_t, sr_val_t *, sr_val_t *, char *,
                  char *);
/* sysrepo callback for inverse boolean values, true in sysrepo is false in UCI
 */
int sr_boolean_reverse_cb(sr_ctx_t *, sr_change_oper_t, sr_val_t *, sr_val_t *,
                          char *, char *);
/* sysrepo callback for list's */
int sr_list_cb(sr_ctx_t *, sr_change_oper_t, sr_val_t *, sr_val_t *, char *,
               char *);
...
int sysrepo_to_uci(sr_ctx_t *, sr_change_oper_t, sr_val_t *, sr_val_t *,
                   sr_event_t);
